...
[![Total Downloads](https://img.shields.io/packagist/dt/iexbase/tron-api.svg?style=flat-square)](https://packagist.org/packages/chikiday/tron-api)

## Install

```bash
> composer require chikiday/tron-api --ignore-platform-reqs
```
## Requirements
